...
describe('Wallet', () => {
  ...
  describe('calculating a balance', () => {
    ...
    describe('and the recipient conducts a transaction', () => {
      ...
      describe('and the sender sender send another transaction to the recipient', () => {
        beforeEach(() => {
          tp.clear();
          senderWallet.createTransaction(wallet.publicKey, addBalance, bc, tp);
          bc.addBlock(tp.transactions);
        ...
        it('calculate the recipient balance only using transactionts since its most recent one', () => {
